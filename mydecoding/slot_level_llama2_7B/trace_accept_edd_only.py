...
def run_trace(
    ...
    slot_cache = edd.init_slot_cache(encoder_out, slot_size=edd.slot_size, apply_dropout=False)
...
def main():
    ...
    ap.add_argument("--slot_size", type=int, default=5, help="Slot size used by draft model")
    args = ap.parse_args()
