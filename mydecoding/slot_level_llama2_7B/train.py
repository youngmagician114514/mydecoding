...
parser.add_argument("--slot_size", type=int, default=5, help="Fixed slot size used by TimeEmbed")
parser.add_argument("--layer_dropout", type=float, default=0.0, help="Drop probability over fusion layers")
parser.add_argument("--slot_dropout", type=float, default=0.0, help="Drop probability over time slots")
